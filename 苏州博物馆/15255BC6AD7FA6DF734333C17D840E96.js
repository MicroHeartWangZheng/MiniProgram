...
! function() {
  ...
  r.prototype = {
        ...
        for (6 == a && a--;;) {
          for (var s = 0; s < 2; s++)
            if (null == this.modules[o][a - s]) {
              var h = !1;
              i < t.length && (h = 1 == (t[i] >>> n & 1)), d.getMask(e, o, a - s) && (h = !h), this.modules[o][a - s] = h, -1 == --n && (i++, n = 7)
    ...
    for (var r = 0, o = 0, n = 0, i = new Array(e.length), a = new Array(e.length), s = 0; s < e.length; s++) {
      ...
      r += h;
      var g = d.getErrorCorrectPolynomial(u),
        f = new v(i[s], g.getLength() - 1).mod(g);
    ...
    var p = new Array(m),
      C = 0;
    for (l = 0; l < o; l++)
      for (s = 0; s < e.length; s++) l < i[s].length && (p[C++] = i[s][l]);
    for (l = 0; l < n; l++)
      for (s = 0; s < e.length; s++) l < a[s].length && (p[C++] = a[s][l]);
    return p
  };
  for (var n = {
      MODE_NUMBER: 1,
      ...
      getLostPoint: function(t) {
        for (var e = t.getModuleCount(), r = 0, o = 0; o < e; o++)
          for (var n = 0; n < e; n++) {
            for (var i = 0, a = t.isDark(o, n), s = -1; s <= 1; s++)
              if (!(o + s < 0 || e <= o + s))
                for (var h = -1; h <= 1; h++) n + h < 0 || e <= n + h || 0 == s && 0 == h || a == t.isDark(o + s, n + h) && i++;
            i > 5 && (r += 3 + i - 5)
          }
        for (o = 0; o < e - 1; o++)
          for (n = 0; n < e - 1; n++) {
        ...
        for (o = 0; o < e; o++)
          for (n = 0; n < e - 6; n++) t.isDark(o, n) && !t.isDark(o, n + 1) && t.isDark(o, n + 2) && t.isDark(o, n + 3) && t.isDark(o, n + 4) && !t.isDark(o, n + 5) && t.isDark(o, n + 6) && (r += 40);
        for (n = 0; n < e; n++)
          for (o = 0; o < e - 6; o++) t.isDark(o, n) && !t.isDark(o + 1, n) && t.isDark(o + 2, n) && t.isDark(o + 3, n) && t.isDark(o + 4, n) && !t.isDark(o + 5, n) && t.isDark(o + 6, n) && (r += 40);
        var l = 0;
        for (n = 0; n < e; n++)
  ...
  v.prototype = {
    ...
    multiply: function(t) {
      for (var e = new Array(this.getLength() + t.getLength() - 1), r = 0; r < this.getLength(); r++)
        for (var o = 0; o < t.getLength(); o++) e[r + o] ^= m.gexp(m.glog(this.get(r)) + m.glog(t.get(o)));
      return new v(e, 0)
    },
    mod: function(t) {
    ...
    for (var o = r.length / 3, n = [], i = 0; i < o; i++)
      for (var a = r[3 * i + 0], s = r[3 * i + 1], h = r[3 * i + 2], u = 0; u < a; u++) n.push(new C(s, h));
    return n
  ...
  (t = function(t, e) {
    ...
    this._oQRCode = new o(e(t, this._htOption.correctLevel), this._htOption.correctLevel), this._oQRCode.addData(t), this._oQRCode.make(), this.makeImage()
    ...
    for (var h = 0; h < o; h++)
      for (var u = 0; u < o; u++) {
        var l = r.isDark(h, u),
          g = u * n,
          f = h * i;
        t.setStrokeStyle(l ? e.colorDark : e.colorLight), t.setLineWidth(1), t.setFillStyle(l ? e.colorDark : e.colorLight), t.fillRect(g, f, n, i), t.strokeRect(Math.floor(g) + .5, Math.floor(f) + .5, a, s), t.strokeRect(Math.ceil(g) - .5, Math.ceil(f) - .5, a, s)
      }
    t.draw()
