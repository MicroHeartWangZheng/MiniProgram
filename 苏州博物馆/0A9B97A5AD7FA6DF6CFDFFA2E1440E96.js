var t = require("./@babel/runtime/helpers/classCallCheck.js"),
  e = require("./@babel/runtime/helpers/createClass.js"),
  i = 310,
  s = "请求参数信息有误",
  o = 600,
  r = "系统错误",
  n = 1e3,
  a = 200,
  l = "https://apis.map.qq.com/ws/",
  d = l + "place/v1/suggestion",
  c = "driving",
  u = "transit",
  g = {
    ...
    rstrHMACMD5: function(t, e) {
      var i, s, o = this.rstr2binl(t),
        r = [],
        n = [];
      for (r[15] = n[15] = void 0, o.length > 16 && (o = this.binlMD5(o, 8 * t.length)), i = 0; i < 16; i += 1) r[i] = 909522486 ^ o[i], n[i] = 1549556828 ^ o[i];
    ...
    getSig: function(t, e, i, s) {
      ...
      return Object.keys(t).sort().forEach((function(e) {
        r.push(e + "=" + t[e])
      })), "search" == i && (o = "/ws/place/v1/search?" + r.join("&") + e), "suggest" == i && (o = "/ws/place/v1/suggestion?" + r.join("&") + e), "reverseGeocoder" == i && (o = "/ws/geocoder/v1/?" + r.join("&") + e), "geocoder" == i && (o = "/ws/geocoder/v1/?" + r.join("&") + e), "getCityList" == i && (o = "/ws/district/v1/list?" + r.join("&") + e), "getDistrictByCityId" == i && (o = "/ws/district/v1/getchildren?" + r.join("&") + e), "calculateDistance" == i && (o = "/ws/distance/v1/?" + r.join("&") + e), "direction" == i && (o = "/ws/direction/v1/" + s + "?" + r.join("&") + e), o = this.md5(o)
    },
    ...
    getDistance: function(t, e, i, s) {
      var o = this.rad(t),
        ...
        l = 2 * Math.asin(Math.sqrt(Math.pow(Math.sin(n / 2), 2) + Math.cos(o) * Math.cos(r) * Math.pow(Math.sin(a / 2), 2)));
    ...
    checkParamKeyEmpty: function(t, e) {
      if (!t[e]) {
        var o = this.buildErrorConfig(i, s + e + "参数格式有误");
    ...
    checkLocation: function(t) {
      ...
      if (!e || !e.latitude || !e.longitude) {
        var o = this.buildErrorConfig(i, s + " location参数格式有误");
    ...
    buildWxRequestConfig: function(t, e, i) {
      ...
      return e.header = {
        ...
        e.statusCode = n, t.fail(s.buildErrorConfig(n, e.errMsg))
      }, e.complete = function(e) {
        switch (+e.statusCode) {
          case n:
            t.complete(s.buildErrorConfig(n, e.errMsg));
            break;
          case a:
            var i = e.data;
            ...
            break;
          default:
            t.complete(s.buildErrorConfig(o, r))
        }
      }, e
    },
    locationProcess: function(t, e, i, s) {
      var o = this;
      if (i = i || function(e) {
          e.statusCode = n, t.fail(o.buildErrorConfig(n, e.errMsg))
        }, s = s || function(e) {
          e.statusCode == n && t.complete(o.buildErrorConfig(n, e.errMsg))
        }, t.location) {
        if (o.checkLocation(t)) {
          e(g.getLocationParam(t.location))
        }
  ...
  h = function() {
    ...
    return e(i, [{
      key: "search",
      value: function(t) {
        if (t = t || {}, g.polyfillParam(t), g.checkKeyword(t)) {
          var e = {
            keyword: t.keyword,
          ...
          var i = t.distance || "1000",
            s = t.auto_extend || 1,
            o = null,
            r = null;
          t.region && (o = t.region), t.rectangle && (r = t.rectangle);
          g.locationProcess(t, (function(n) {
            o && !r ? (e.boundary = "region(" + o + "," + s + "," + n.latitude + "," + n.longitude + ")", t.sig && (e.sig = g.getSig(e, t.sig, "search"))) : r && !o ? (e.boundary = "rectangle(" + r + ")", t.sig && (e.sig = g.getSig(e, t.sig, "search"))) : (e.boundary = "nearby(" + n.latitude + "," + n.longitude + "," + i + "," + s + ")", t.sig && (e.sig = g.getSig(e, t.sig, "search"))), wx.request(g.buildWxRequestConfig(t, {
      ...
      value: function(t) {
        if (t = t || {}, g.polyfillParam(t), g.checkKeyword(t)) {
          ...
          if (t.address_format && (e.address_format = t.address_format), t.filter && (e.filter = t.filter), t.location) {
            g.locationProcess(t, (function(i) {
              e.location = i.latitude + "," + i.longitude, t.sig && (e.sig = g.getSig(e, t.sig, "suggest")), wx.request(g.buildWxRequestConfig(t, {
                url: d,
                data: e
              }, "suggest"))
            }))
          } else t.sig && (e.sig = g.getSig(e, t.sig, "suggest")), wx.request(g.buildWxRequestConfig(t, {
            url: d,
            data: e
          }, "suggest"))
        }
      ...
      value: function(t) {
        ...
        g.locationProcess(t, (function(i) {
          e.location = i.latitude + "," + i.longitude, t.sig && (e.sig = g.getSig(e, t.sig, "reverseGeocoder")), wx.request(g.buildWxRequestConfig(t, {
      ...
      key: "geocoder",
      value: function(t) {
        if (t = t || {}, g.polyfillParam(t), !g.checkParamKeyEmpty(t, "address")) {
          var e = {
            address: t.address,
            output: "json",
            key: this.key
          };
          t.region && (e.region = t.region), t.sig && (e.sig = g.getSig(e, t.sig, "geocoder")), wx.request(g.buildWxRequestConfig(t, {
            url: "https://apis.map.qq.com/ws/geocoder/v1/",
            data: e
          }, "geocoder"))
        }
      ...
      value: function(t) {
        ...
        t.sig && (e.sig = g.getSig(e, t.sig, "getCityList")), wx.request(g.buildWxRequestConfig(t, {
      ...
      value: function(t) {
        if (t = t || {}, g.polyfillParam(t), !g.checkParamKeyEmpty(t, "id")) {
          var e = {
            id: t.id || "",
            output: "json",
            key: this.key
          };
          t.sig && (e.sig = g.getSig(e, t.sig, "getDistrictByCityId")), wx.request(g.buildWxRequestConfig(t, {
      ...
      value: function(t) {
        if (t = t || {}, g.polyfillParam(t), !g.checkParamKeyEmpty(t, "to")) {
          var e = {
            mode: t.mode || "walking",
            to: g.location2query(t.to),
            output: "json",
            key: this.key
          };
          if (t.from && (t.location = t.from), "straight" == e.mode) {
            var i = function(i) {
              for (var s = g.getEndLocation(e.to), o = {
                  message: "query ok",
                  result: {
                    elements: []
                  },
                ...
                distance: g.getDistance(i.latitude, i.longitude, s[r].lat, s[r].lng),
                duration: 0,
                from: {
                  lat: i.latitude,
                  lng: i.longitude
            ...
            g.locationProcess(t, i)
          } else {
            i = function(i) {
              e.from = i.latitude + "," + i.longitude, t.sig && (e.sig = g.getSig(e, t.sig, "calculateDistance")), wx.request(g.buildWxRequestConfig(t, {
      ...
      value: function(t) {
        if (t = t || {}, g.polyfillParam(t), !g.checkParamKeyEmpty(t, "to")) {
          ...
          var i;
          t.mode = t.mode || c, i = "https://apis.map.qq.com/ws/direction/v1/" + t.mode, t.from && (t.location = t.from), t.mode == c && (t.from_poi && (e.from_poi = t.from_poi), t.heading && (e.heading = t.heading), t.speed && (e.speed = t.speed), t.accuracy && (e.accuracy = t.accuracy), t.road_type && (e.road_type = t.road_type), t.to_poi && (e.to_poi = t.to_poi), t.from_track && (e.from_track = t.from_track), t.waypoints && (e.waypoints = t.waypoints), t.policy && (e.policy = t.policy), t.plate_number && (e.plate_number = t.plate_number)), t.mode == u && (t.departure_time && (e.departure_time = t.departure_time), t.policy && (e.policy = t.policy));
          g.locationProcess(t, (function(s) {
            e.from = s.latitude + "," + s.longitude, t.sig && (e.sig = g.getSig(e, t.sig, "direction", t.mode)), wx.request(g.buildWxRequestConfig(t, {
              url: i,
              data: e
            }, "direction"))
          }))
