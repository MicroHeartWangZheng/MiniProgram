    ...
    methods: {
      touchstart: function(t) {
        if (!(t.touches.length > 1)) {
          if (null === this.allowDrag) return this.isRight = null, this.allowDrag = !1, this.showTrinsition = !0, void(this.nowX = 0);
          this.showTrinsition = !1, this.allowDrag = !0;
          var i = t.touches[0].clientX - t.currentTarget.offsetLeft;
          this.startX = i, this.endX = this.sliderStyle.left.replace("px", "") - 0
        }
      },
      ...
      touchmove: function(t) {
        if (!(t.touches.length > 1) && this.allowDrag) {
          ...
          var e = this.endX + 1.5 * i;
          if (e - this.maxLeft <= 0) this.$set(this.sliderStyle, "left", Math.round(e) + "px");
          else {
            var n = e - this.maxLeft;
            this.$set(this.sliderStyle, "left", Math.round(this.maxLeft - n) + "px")
          }
        }
      },
      ...
      confirm: function() {
        ...
        this.playState = "paused", this.$set(this.sliderImgStyle, "animationPlayState", "paused"), i.index.createSelectorQuery().in(this).select("#slider").boundingClientRect((function(i) {
          var e = .1307 * t.windowInfo.windowWidth,
            n = t.windowInfo.windowWidth * (1 - .2614);
          t.nowPosition = (i.left - e) / n * 100;
          t.nowPosition + t.diffL >= t.sLeft && t.nowPosition - t.diffR <= t.sLeft ? (t.isRight = !0, t.$emit("afterAnswer")) : t.isRight = !1
        })).exec()
      },
      init: function() {
        var t = this.questionInfo.correctOption,
          e = Math.round(40 * Math.random() + 10),
          n = Math.round(40 * Math.random() + 40);
        t.top = e, t.left = n;
        var o = 554,
          s = i.wx$1.getSystemInfoSync(),
          r = .7386 * s.windowWidth / o;
        this.windowInfo = s;
        var h = t.originalWidth / o * 100,
          l = t.originalHeight / 368 * 100,
          a = this.questionInfo.diffL / (o * r) * 100,
          u = this.questionInfo.diffR / (o * r) * 100;
        l + t.top > 100 && (t.top = 100 - l);
        var f = {
          width: Math.round(r * o * h / 100) + "px",
          height: Math.round(r * o * h / 100) + "px",
          top: t.top + "%",
          left: Math.round(r * o * t.left / 100) + "px"
        };
        this.maxLeft = Math.round(.7386 * s.windowWidth * (100 - h) / 100);
        var d = {
            width: Math.round(r * o * h / 100) + "px",
            height: Math.round(r * o * h / 100) + "px",
            top: t.top + "%",
        ...
        this.sLeft = t.left, this.diffL = a, this.diffR = u, this.sliderStyle = f, this.sliderImgStyle = d, this.imgStyle = c, this.isInit = !0
      }
    }
  };
Array || i.resolveComponent("uni-icons")(), Math;
var n = i._export_sfc(e, [
  ["render", function(t, e, n, o, s, r) {
    return i.e({
      a: !1 === s.isRight
    }, (s.isRight, {}), {
      b: !0 === s.isRight
      ...
      n: s.sliderImgStyle.top,
      o: s.nowX + "px",
      p: s.sliderImgStyle.width,
      q: s.sliderImgStyle.width,
      r: "url('".concat(s.slideComBg, "')")
    }) : {}, {
      s: s.showTrinsition ? "" : 1,
      t: s.nowX + "px",
      v: !1 === s.allowDrag
    }, (s.allowDrag, {}), {
      w: null === s.allowDrag
