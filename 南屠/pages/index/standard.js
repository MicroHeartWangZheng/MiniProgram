...
var n = {
  ...
  methods: {
    ...
    skip: function(i) {
      e.index.navigateTo({
        url: "/jdm_pages/appointment/index?typeIndex=" + i
      })
    }
  }
};
...
var t = e._export_sfc(n, [
  ["render", function(i, n, t, s, r, a) {
    return e.e({
      ...
      j: e.sr("auditResultNoticeDialogRef", "5b4d6f76-1"),
      k: e.sr("mainNoticeDialogRef", "5b4d6f76-2"),
      l: e.o(a.openMDialog),
      m: e.p({
        notice: r.notice
      }),
      n: e.sr("appointNoticeDialogRef", "5b4d6f76-3"),
      o: e.p({
        currentIndex: 0
      })
    }, {
