...
var n = {
  components: {
    ...
    appointNoticeDialog: function() {
      return "../../components/index/appointNoticeDialog.js"
    },
  ...
  methods: {
    ...
    readFileDeail: function() {
      ...
      if (t) {
        ...
        var r = new Date;
        r.setHours(0), r.setMinutes(0), r.setMilliseconds(0), r.setSeconds(0), (r = r.getTime()) - t < 864e5 && (s = !1)
      }
    ...
    skip: function(i) {
      e.index.navigateTo({
        url: "/english_pages/appointment/index?typeIndex=" + i
      })
    }
  }
};
Array || (e.resolveComponent("page-head") + e.resolveComponent("auditResultNoticeDialog") + e.resolveComponent("mainNoticeDialog") + e.resolveComponent("appointNoticeDialog") + e.resolveComponent("tabbar") + e.resolveComponent("desktop-forbidden"))();
var t = e._export_sfc(n, [
  ["render", function(i, n, t, s, r, a) {
    return e.e({
      a: o._imports_0$1,
      b: e.p({
        capsule: !0
      }),
      c: !a.isDesktopForbiddenPopupVisible
    }, a.isDesktopForbiddenPopupVisible ? {} : {
      d: o._imports_1$5,
      e: o._imports_2$1,
      f: e.o((function() {
        return a.versionswitching && a.versionswitching.apply(a, arguments)
      })),
      g: e.o((function(e) {
        return a.skip(1)
      })),
      ...
      j: e.sr("auditResultNoticeDialogRef", "16ad5f15-1"),
      k: e.sr("mainNoticeDialogRef", "16ad5f15-2"),
      l: e.o(a.openMDialog),
      m: e.p({
        notice: r.notice
      }),
      n: e.sr("appointNoticeDialogRef", "16ad5f15-3"),
      o: e.p({
        currentIndex: 0
      })
    }, {
      p: a.indexIsGray ? "grayscale(.95)" : "none"
    })
  }],
  ["__scopeId", "data-v-16ad5f15"]
]);
