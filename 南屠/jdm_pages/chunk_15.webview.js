...
var oP9=_n('view')
var cQ9=_n('web-view')
_rz(z,cQ9,'src',0,e,s,gg)
_(oP9,cQ9)
var oR9=_mz(z,'back-home',['bind:__l',1,'uI',1],[],e,s,gg)
_(oP9,oR9)
_(r,oP9)
return r
}
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['jdm_pages/my/subscribe/history.wxss'] = setCssToHead([],undefined,{path:"./jdm_pages/my/subscribe/history.wxss"});
}